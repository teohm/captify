...
1. Run capify.
2. Overwrite Capistrano files with default template: rails-basic (see capistrnao-templates[https://github.com/teohm/capistrano-templates]).

To use a different template:

  cd my_project
  captify -t sinatra-basic .
